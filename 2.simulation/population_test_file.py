...
class Population():
    ...
    def simulate(self):
        for i in range(100):
            ...
            self.population.append(Person(50, 2023, self.adherence_percentage, self.counter, self.crc_prevalence))
            self.counter += 1
            ...
            # Manage people who have not been treated for cancer
                ...
                if person.screenable == True and self.screenable(person.age) == True:
                    ...
                    if person.detectable_cancer == True:
                        ...
                        print('Person: ', person.counter, '\nProbability: ', probability, '\nYear:', self.year)
                        if probability < self.fit_sensitivity:
                            person.treat_cancer()
